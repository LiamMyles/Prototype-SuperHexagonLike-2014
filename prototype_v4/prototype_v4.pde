...
void setup()
{
  ...
  planetImg = loadShape("planet-1.svg");
  shipReady = loadShape("Ship-Ready.svg");
  mainmenuUI = loadShape("mainMenu_ui.svg");
  gameoverUI = loadShape("gameover_ui.svg");
  highscoreUI = loadShape("highScore_ui.svg");
  classicUI = loadShape("classic_ui.svg");
  fireUI = loadShape("fire_ui.svg");
  trainUI = loadShape("train_ui.svg");
...
void mainMenuGUI()
{
  ...
  shapeMode(RIGHT);
  shape(mainmenuUI,0,0,width,height);
  shapeMode(CENTER);
}
...
void highscoreGUI()
{
  ...
  shapeMode(RIGHT);
  shape(highscoreUI,0,0,width,height);
  shapeMode(CENTER);
}
...
void gameOverGUI()
{
  ...
  shapeMode(RIGHT);
  shape(gameoverUI,0,0,width,height);
  shapeMode(CENTER);
}
////////////////////////////////////CONTROLS////////////////////////////////////
////////////////////////////////////CONTROLS////////////////////////////////////
...
void screenDisplay()
{
  ...
  if (appScreen == 0)//Starting/main menu
  {
    ...
    {
      shapeMode(RIGHT);
      shape(trainUI,0,0,width,height);
      shapeMode(CENTER);
    }
    playerLives = 3;
    playerScore = 0;
